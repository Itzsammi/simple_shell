...
/**
 * get_environ - it returns the str array cp of our environment
 * @info: Struct containing potential arg's. Used to maintain
...
/**
 * _setenv - It initialize a new env var or modify an existing one
