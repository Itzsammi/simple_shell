...
/**
 * get_history_file - it gets the histor file
 ...
 * @info: Struct containing potential arg. Used to maintain buf
 * @buf: buf
 ...
 * @info: Struct containing potential arg's. Used to maintain buf
